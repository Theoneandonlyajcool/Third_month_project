    ...
    <div>
      <div className='headerBody'>
        <div className='headerWrapper'>
            ...
            menuSideBar && (
              <div className='menuDrop'>
                <div className='cancel'>
                  < FaXmark className='Xmark' onClick={()=> setMenuSideBar(!menuSideBar)} />
                </div>
          ...
          <div className='icons'>
            <div className='profile_icon'><LuUserRound /></div>
          ...
          <div className='cartWrapper'>
            <div style={{ display: "flex", alignItems: "center" }}>
              <p>Your Cart</p>
              < MdOutlineArrowDropDown onClick={() => setSideBar(!sidebar)} />
            </div>
            <span>$1256.00</span>

          </div>
          {
            sidebar && (<div className='cartDrop'>
              <div className='markSec'>
                <FaXmark className='mark' onClick={() => setSideBar(!sidebar)} />
              </div>
              <div className='items' >
                <h4>Your cart</h4>
        ...
        <div className='menu-icon'>
          <IoMenuOutline className='menu' onClick={()=> setMenuSideBar(!menuSideBar)} />
        </div>
      </div>
    </div>
  )
